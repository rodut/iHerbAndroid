...
class CreateAccountTest05(unittest.TestCase):
    ...
    def test_create_account_05(self):
        ...
        # Verify if "I want to receive exclusive..." text is displayed
        element = wait.until(EC.presence_of_element_located((By.XPATH, CreateAccount.want_receive_text)))
        assert element.is_displayed(), "'I want to receive exclusive...' text is displayed."


if __name__ == "__main__":
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(
        output="C:\\Users\\Tudor\\PycharmProjects\\iHerbMobile\\Reports",
        report_name="CreateAccountTest05"))
