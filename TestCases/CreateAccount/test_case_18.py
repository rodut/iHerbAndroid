...
class CreateAccountTest18(unittest.TestCase):
    email = "aaa@bbb22.com"
    mobile = "2125552222"
    password = "12345678"
    ...
    def test_create_account_18(self):
        ...
        create.tap_confirm_password_eye()
        # Verify if the password can be seen
        element = wait.until(EC.presence_of_element_located((By.XPATH, CreateAccount.confirm_password_field))).get_attribute("text")
        assert element == "12345678", "The confirm password cannot be seen."
        # Tap on Password "eye" button
        create.tap_confirm_password_eye()
        ...
        assert element == "true", "The confirm password was not hidden."


if __name__ == "__main__":
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(
        output="C:\\Users\\Tudor\\PycharmProjects\\iHerbMobile\\Reports",
        report_name="CreateAccountTest18"))
