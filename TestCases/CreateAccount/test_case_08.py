...
class CreateAccountTest08(unittest.TestCase):
    ...
    def test_create_account_08(self):
        ...
        create.tap_privacy_policy_link()
        # Verify if "Terms and Conditions" page was opened
        element = wait.until(EC.presence_of_element_located((By.XPATH, CreateAccount.privacy_policy_page)))
        assert element.is_displayed(), "'Privacy Policy' page was opened."


if __name__ == "__main__":
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(
        output="C:\\Users\\Tudor\\PycharmProjects\\iHerbMobile\\Reports",
        report_name="CreateAccountTest08"))
