...
class CreateAccountTest02(unittest.TestCase):
    ...
    def test_create_account_02(self):
        ...
        # Verify if "Mobile Number" text is displayed
        element = wait.until(EC.presence_of_element_located((By.XPATH, CreateAccount.mobile_number_text)))
        assert element.is_displayed(), "'Mobile Number' text is not displayed."


if __name__ == "__main__":
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(
        output="C:\\Users\\Tudor\\PycharmProjects\\iHerbMobile\\Reports",
        report_name="CreateAccountTest02"))
