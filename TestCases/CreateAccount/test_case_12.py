...
class CreateAccountTest12(unittest.TestCase):
    email = "dddaddd.com"
    mobile = "2125557890"
    password = "password"
    ...
    def test_create_account_12(self):
        ...
        # Verify if an error message appears ("Please include an '@' in the email address. 'dddaddd.com' is missing an '@'.")
        element = wait.until(EC.presence_of_element_located((By.XPATH, CreateAccount.incorrect_email_error)))
        assert element.is_displayed(), "'Please include an '@' in the email address. 'dddaddd.com' is missing an '@'.' error message appears."


if __name__ == "__main__":
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(
        output="C:\\Users\\Tudor\\PycharmProjects\\iHerbMobile\\Reports",
        report_name="CreateAccountTest12"))
