...
class CreateAccountTest10(unittest.TestCase):
    email = "aaa@bbb.com"
    mobile = "123456789"
    password = "password"
    ...
    def test_create_account_10(self):
        ...
        # Enter only 9 digits in mobile phone field
        ...
        element = wait.until(EC.presence_of_element_located((By.XPATH, CreateAccount.invalid_phone_number_2)))
...
if __name__ == "__main__":
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(
        ...
        report_name="CreateAccountTest10"))
